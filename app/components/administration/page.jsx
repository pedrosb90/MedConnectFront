              ...
              <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
                <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                  ...
                  <div className="relative pl-16">
                    ...
                    <dd className={styles.citas_con}>10
                    <button className={styles.button}>Ver Detalles</button></dd>
                  </div>
                  <div className="relative pl-16">
                    <dt className="text-base font-semibold leading-7 text-gray-900">
                    ...
                    <div className={styles.resumen}><dd className={styles.citas_con}>34
                    <h2>Citas activas</h2></dd>
                    <dd className={styles.citas_con}>7
                    <h2>Total de Medicos</h2></dd>
                    <dd className={styles.citas_con}>5
                    <h2>Total de especialidades</h2></dd></div>
                  </div>
