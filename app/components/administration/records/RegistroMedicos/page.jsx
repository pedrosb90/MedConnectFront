...
export default function Medicos(){
    ...
    const deleteMed =(id)=>{
      ...
      count == 1 && setError({...error,text:`Se borrara el Medico: ${borrar?.user.last_name} de click otra vez para confirmar`,alert:true})
    ...
    return(
        <div className={styles.container}>
          ...
          <h1 className={styles.title + ' mb-8 text-3xl font-sans leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-5xl'}>Tabla de Medicos</h1>
        ...
        <tbody>
        {medicos.length && medicos.map((med, index) => (
