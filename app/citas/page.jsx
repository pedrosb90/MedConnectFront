...
export default function Citas() {
    return (
      ...
      <div className=" mx-auto  sm:p-8  ">
        <div className="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl w-full" style={{ minHeight: '19rem' }}>
          ...
          <Image className="absolute inset-0 object-cover object-center" src={img} alt="NOT_FOUND"  />
          ...
          <div className="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
            <div className="p-12 md:pr-24 md:pl-16 md:py-12">
              <div className="text-gray-600"><span className="text-gray-900"><h1 className={styles.title}>¡Agenda tu cita ya!</h1></span></div>
              <p>Tenemos una amplia lista de profesionales y servicios médicos. Ofrecemos traumatología, cardiología, ginecología/obstetricia, mamografías, oftalmología, otorrinolaringología, pediatría, y más. Selecciona tus servicios y elige al medico de tu preferencia."</p>
              <button className="flex items-baseline mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900" href="">
