...
export default function BottonEspe({especialidades , handleClick}){
  ...
  const especial = especialidades.length ? especialidades:[]
    ...
    return(
      ...
      >
        Servicios
        {isOpen ?<svg className="h-6 w-6 text-black"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" stroke-linecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <polyline points="6 15 12 9 18 15" /></svg>:
